...
You can find all of Daily Italian's translations in the [`DailyLibrary/Dictionaries`](./DailyItalianLibrary/Sources/DailyLibrary/Dictionaries) directory. Follow these steps to fix a translation mistake:

1. Find the mistake in its language's `.swift` file. For example, [line 16 of `ItalianEnglish.swift`](./DailyItalianLibrary/Sources/DailyLibrary/Dictionaries/ItalianEnglish.swift#L16).
